...
public class User {
    ...
    @Size(min = 3,message = "The first name field must be greater than the three characters")
    private String first_name;
    @NotEmpty(message = "The last name field cannot be empty")
    @Size(min = 3,message = "The last name field must be greater than the three characters")
