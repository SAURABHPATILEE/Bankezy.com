...
import com.bankezy.repository.PaymentRepository;
import com.bankezy.repository.TransactRepository;
...
public class TransactController {
    ...
    public String withdraw(@RequestParam("withdrawal_amount")String withdrawalAmount,
        ...
        if(withdrawalAmount.isEmpty() || accountID.isEmpty()){
            System.out.println("in post mapping withdraws before error and redirect attribute");
            errorMessage = "Withdrawal Amount and Account Withdrawing From Cannot be Empty ";
            redirectAttributes.addFlashAttribute("error", errorMessage);
            System.out.println("in post mapping withdraws after error and redirect attribute");
            return "redirect:/app/dashboard";
        }
